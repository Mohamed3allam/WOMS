...
function RegistrationFormEntity() {
            ...
            script.addEventListener('load', () => {
                ...
                if (window.hbspt) {
                    ...
                    window.hbspt.forms.create({
                        portalId: '143857385',
                        formId: '1bfbb70d-6a51-4d17-baf8-903fb8fb1995',
                        target: '#hubspotForm'
                    })
                }
            });
  ...
  return (
    <div className='container col m-5'>
        <Form className='p-5' style={{border:'1px solid grey',borderRadius:'10px'}}>
            <h2 className='h2'>Registration For Entities</h2>
            {/* <div className=' row'>
...
export default RegistrationFormEntity;