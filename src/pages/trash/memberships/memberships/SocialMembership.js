...
const SocialMembership = () => {
  return (
              ...
              <div className="single-schedule first wow fadInUp" data-wow-duration="1s" data-wow-delay=".1s">
                <div className="inner">
                  ...
                  <div className="single-content text-white">
                    <h3 className='text-white'>Social Membership</h3>
                    <p className='lead'>Advantages</p>
                    <ul>
                      <li>
                        Allows doctors to participate in activities.
                      </li>
                      <li>
                        Social and cultural activities organized by the organization medical. 
                      </li>
                     </ul>
    ...
    // <div className='wow fadeInUp' data-wow-duration="1s" data-wow-delay=".7s">
    ...
    //                     <h2 className='text-center' style={{color:'green'}}>Social Membership</h2>
