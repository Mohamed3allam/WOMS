...
const GeneralMembership = () => {
  return (
              ...
              <div className="single-schedule first wow fadInUp" data-wow-duration="1s" data-wow-delay=".1s">
                <div className="inner">
                  ...
                  <div className="single-content text-white">
                    <h3 className='text-white'>General Membership</h3>
                    <p className='lead'>Advantages</p>
                    <ul>
                      <li>
                        Allows doctors to access resources and information provided by the medical organization.
                      </li>
                      <li>
    ...
    // <div>
    //     <div className="blog-wrapper container wow fadeInUp" data-wow-duration="1s" data-wow-delay=".1s">
    ...
    //                     <h2 className='text-center' style={{color:'green'}}>General Membership</h2>
    //                     <h3  style={{color:'green', fontWeight:'lighter'}}>Advantages</h3>
    //                     <ul>
    //                       <li>
    //                         Allows doctors to access resources and information provided by the medical organization.
    //                       </li>
    ...
    //                       </li>
    //                     </ul>
    //                     <h3  style={{color:'green', fontWeight:'lighter'}}>Benefits</h3>
    //                     <ul>
    //                       <li>
    //                         Enhance knowledge and skills in a specialty Medicine.
    //                       </li>
